<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		</div><!-- Top Story Section --><div class="grid__col topStory"><div class="topHeading"><span class="sizing">TOP STORY</span></div><a class="topImg"><?php echo get_the_post_thumbnail($recentTop, 'full');?></a><div class="topText"><a><?php echo get_the_title($recentTop);?></a></div></div><!-- Calendar Section --><div class="grid__col calendarSect"><span class="calHeading">Calendar</span><hr class="yellowLine line2">Calendar section under construction. Thank you for your patience!</div><!-- Ad Side Bar --><div class="sideAds"><img src="<?php echo bloginfo('template_url'); ?>/pics/spdbAd.jpeg" class="ads"><img src="<?php echo bloginfo('template_url'); ?>/pics/vmdoAd.jpg" class="ads"><img src="<?php echo bloginfo('template_url'); ?>/pics/tree.jpg" class="ads"><img src="<?php echo bloginfo('template_url'); ?>/pics/crozet.jpeg" class="crozet ads"></div>
